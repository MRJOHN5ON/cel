      ...
      <header className="header">
        <div className="header__inner">
          <div className="header__brand">
            ...
            <span className="header__wordmark">Cel</span>
          </div>
      ...
      <div className="app__content">
        {backendOnline === false && (
          <div className="offline-banner" role="alert">
            <IconError size={16} />
            <p>
              Can&apos;t reach the server. Restart Cel or run <code>./start.sh</code> in dev mode.
            </p>
          </div>
        )}
            ...
            <>
              <section className="hero hero--landing">
                ...
                <h2 className="hero__title">
                  Remove backgrounds.<br />For free.
                </h2>
                <p className="hero__subtitle">
                  Studio-quality transparent PNGs on your Mac.
                  <br />
